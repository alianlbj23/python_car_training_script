...
class UnityAdaptor():
    ...
    def calculate_relative_angle_unity_gloabl(self, lidar_direction_from_car_x, lidar_direction_from_car_y,
    ...
    def transfer_obs(self, obs, ai_action):
        ...
        wheel_quaternion_left_front = [obs['ROS2WheelQuaternionLeftFront'][0],
                                       ...
                                       obs['ROS2WheelQuaternionLeftFront'][
                                           3]]  # 48 49 50 51ROS2WheelQuaternionRightBack
        wheel_left_front_roll_x, wheel_left_front_pitch_y, wheel_left_front_yaw_z = self.euler_from_quaternion(
        ...
        wheel_right_front_roll_x, wheel_right_front_pitch_y, wheel_right_front_yaw_z = self.euler_from_quaternion(
        ...
        state = State(
            ...
            wheel_angular_vel=WheelAngularVel(left_back=obs['ROS2WheelAngularVelocityLeftBack'][1],  # obs[30]
                                              ...
                                              # obs[37 39] obs[40 41 42 43] ROS2WheelQuaternionLeftBack
                                              ),
